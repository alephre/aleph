...
from aleph.config.constants import GEOLOCATION_DATABASE_PATH, GEOLOCATION_DATABASE_ASN, GEOLOCATION_DATABASE_CITY
...
def get_location_for_ip(ip_addr):
    ...
    try:
        reader = Reader(os.path.join(GEOLOCATION_DATABASE_PATH, GEOLOCATION_DATABASE_CITY))
...
def get_asn_for_ip(ip_addr):
    ...
    try:
        reader = Reader(os.path.join(GEOLOCATION_DATABASE_PATH, GEOLOCATION_DATABASE_ASN))
